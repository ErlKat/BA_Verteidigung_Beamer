...
\author[Stefan Schildbach]{Stefan Schildbach, M.Sc.}
...
\email{schildba@hs-mittweida.de} % \email{eMail}
...
\begin{document}
	...
	\begin{frame}[fragile]{Mögliche Optionen (2/3)}{Grundlegende Stilelemente beeinflussen}
		\begin{itemize}
			...
			\begin{itemize}
				\item \textcolor{hsmw}{subsectionslide} fügt eine zusätzliche Seite für jede \verb!\subsection! ein.\par Ist mit \textcolor{hsmw}{sectionslide} kombinierbar. 
	...
	\begin{frame}[fragile]{Zusätzliche Befehle}{Folien erstellen oder Werte manipulieren}
		\begin{itemize}
			...
			\begin{itemize}
				\item Kontaktdaten in Präambel ergänzen: \verb!\email{eMail}! ...
