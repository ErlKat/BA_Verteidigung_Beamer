...
%	nofacultyicon,		% Hides the faculty icon on title page
	colormath,			% Enables coloring of math text
...
\begin{document}
	...
	\begin{frame}[fragile]{Mögliche Optionen (1/2)}{Grundlegende Stilelemente beeinflussen}
	...
	\end{frame}
	\begin{frame}[fragile]{Mögliche Optionen (2/2)}{Grundlegende Stilelemente beeinflussen}
		\begin{itemize}
