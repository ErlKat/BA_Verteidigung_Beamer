...
%	\begin{itemize}
%		\item Automatisierung \& Beschleunigung von Analysen
%		\item Reduktion menschlicher Fehler
%		\item Schnellere Reaktion auf Bedrohungen
%		\item Abfederung des Fachkräftemangels
%	\end{itemize}
%\end{frame}
